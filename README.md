...
- **Cloud-native systems** — scalable backends, storage, event-driven architectures  
...
- **Cross-platform systems** — desktop agents, mobile apps, and web platforms  
...
- Cloud-integrated services with scalable storage and real-time synchronization  
...
- Real-time synchronization across distributed clients via cloud-backed infrastructure  
...
Docker · Redis · WebSocket · AWS · CI/CD  

**AI / Search**  
pgvector · Vector Retrieval · Multimodal Search · LLM Orchestration  
...
- Real-time voice and agent-based systems  
